    ...
    <div className={`glass-panel p-4 ${className}`}>
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className={`flex items-center space-x-2 px-6 py-3 rounded-xl font-medium transition-all duration-200 shadow-lg ${isExecuting
        ...
        {customButtons.map((button, index) => (
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 ${button.disabled || isExecuting
